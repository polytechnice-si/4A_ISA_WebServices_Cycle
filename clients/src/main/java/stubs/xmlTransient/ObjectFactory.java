 ...
 * generated in the stubs.xmlTransient package. 
...
public class ObjectFactory {
    ...
    private final static QName _ListCustomersResponse_QNAME = new QName("http://www.polytech.unice.fr/si/4a/isa/demo/transient/", "listCustomersResponse");
    private final static QName _ListCustomers_QNAME = new QName("http://www.polytech.unice.fr/si/4a/isa/demo/transient/", "listCustomers");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: stubs.xmlTransient
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.polytech.unice.fr/si/4a/isa/demo/transient/", name = "listCustomersResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.polytech.unice.fr/si/4a/isa/demo/transient/", name = "listCustomers")
